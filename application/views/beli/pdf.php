...
$transportir = $info['transportir']; 
$nama_transportir = $this->supplier_model->NamaTransportir($info['transportir']); 
$kode_transportir = $this->supplier_model->KodeTransportir($info['transportir']); 
...
$this->fpdf->Cell(4,0.5,": ".$no.".".$tg."".$bln."/".$doc."/".$KodeSupplier."/".$kode."/".$thn,'0',0,'L');
...
$this->fpdf->SetFont('Arial','',10);
$this->fpdf->Cell(9,0.5,"",0,0,'L'); 
$this->fpdf->Cell(2,0.5,"SH ",0,0,'L');
$this->fpdf->Cell(4,0.5,": $sh",0,0,'L');
}
...
$this->fpdf->SetFont('Arial','',10);
$this->fpdf->Cell(9,0.5,"",0,0,'L'); 
$this->fpdf->Cell(2,0.5,"SP ",0,0,'L');
$this->fpdf->Cell(4,0.5,": $sp",0,0,'L');
}
...
$this->fpdf->Ln(0.4);
$this->fpdf->Cell(4,0.5,"Transportir",0,0,'L');
$this->fpdf->Cell(13,0.5,": $nama_transportir",0,0,'L');

$this->fpdf->Ln(0.4);
$this->fpdf->Cell(4,0.5,"Kode Vendor Transportir",0,0,'L');
$this->fpdf->Cell(13,0.5,": $kode_transportir",0,0,'L');
...
$this->fpdf->Cell(5.6,0.5,"",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"Direktur Utama",0,0,'C');
...
$this->fpdf->Cell(1,0.5,"",0,0,'L');
$this->fpdf->Cell(1,0.5,"",0,0,'L');
$this->fpdf->Cell(15,0.5,$nama,0,0,'L');
...
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Arial','',10);
$this->fpdf->Cell(5.6,0.5,"Disetujui dan disanggupi",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"Disetujui",0,0,'C');

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','B',10);
$this->fpdf->Cell(5.6,0.5,$NamaSupplier,0,0,'C');
$this->fpdf->Cell(5.6,0.5,"",0,0,'C');
...
$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',10);
$this->fpdf->Cell(5.6,0.5,"Supplier",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"",0,0,'C');
$this->fpdf->Cell(5.6,0.5,"Direktur Utama",0,0,'C');
...
$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',10);
$this->fpdf->Cell(5.6,0.5,"Supply Chain",0,0,'C');
...
$this->fpdf->Output("PURCHASE_ORDER_$no.pdf","I");
?>

		...
		<div class="box box-warning">
			<div class="box-body">
				...
				<div class="text-center">
					...
					<a class="btn btn-primary" style="cursor: pointer;" onclick="location.href='<?php echo site_url('setting/photo');?>'"><i class="fa fa-picture-o"></i> Edit Foto</a>
			...
			<div class="box-body">
				...
				<div class="form-group has-success">
					<label><strong>Pilih Gambar Logo Usaha</strong></label>
					<input name="gambar" type="file"/>
						<div class="box-body text-center">
							<?php if($info['logo_1']==''){ ?>
							<img width="400px" src="<?php echo base_url();?>uploads/setting/logo.png"/>
							<?php }else{ ?>
							Nama File : <?php echo $info['logo_1'];?><br/><br/>
							<img width="400px" src="<?php echo base_url('/uploads/setting/'.$info['logo_1']);?>"/>
							<?php } ?>
						</div><!-- /.box-body -->
				</div>
			</div><!-- /.box-body -->

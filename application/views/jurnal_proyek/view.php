      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
                ...
                <section class="content-header">
                    <h1>
                        <a class="btn btn-warning" style="cursor: pointer;" onclick="location.href='<?php echo site_url('jurnal_proyek');?>'"> Kembali </a>
                        <a class="btn btn-primary" target="_blank" href="<?php echo site_url('jurnal_proyek/pdf/'.$this->uri->segment(3));?>"><i class="fa fa-print"></i> Print</a>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a style="cursor: pointer;" onclick="location.href='<?php echo site_url('home');?>'"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                        <li><a style="cursor: pointer;" onclick="location.href='<?php echo site_url('jurnal_proyek');?>'"><?php echo $title;?></a></li>

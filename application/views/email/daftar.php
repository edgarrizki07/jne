            ...
            <aside class="right-side">
                ...
                <section class="content-header">
					<div class="input-group-btn">
						...
						<a href="#" onclick="location.href='<?php echo base_url('dataemail/emailauto_import.php');?>'" class="btn btn-primary"><i class="fa fa-sign-in"></i><b> Import Data</b></a>
						<a href="#" onclick="location.href='<?php echo base_url('dataemail/emailauto_export.php');?>'" class="btn btn-primary"><i class="fa fa-sign-out"></i><b> Export Data</b></a>
	...
	$sat = $this->db->get('emailauto'); $pesan = $sat->result(); ?>

<?php
	...
	$judul='Debitur/Creditur';
	$tgl1 = $this->jurnal_model->tgl_indo($this->uri->segment(3));
	$tgl2 = $this->jurnal_model->tgl_indo($this->uri->segment(4));
	$now = date("Y-m-d");
...
$this->fpdf->Cell(27,0.5,"Rencana dan Realisasi Investasi dalam Tahun ".$tgl1." - ".$tgl2,'0',0,'C');
...
$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','BI',9);
$this->fpdf->Cell(27,0.5,"Tahun ".$tgl1,'0',0,'C');
...
$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','B',10);
$this->fpdf->Cell(17,0.5,"REKAP PENJUALAN BBM TAHUN",'0',0,'C');

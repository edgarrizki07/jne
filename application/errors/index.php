  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      <div class="login-logo">
		<h1>Terimakasih Telah Mengunjungi Web Ini</h1>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
		<h3 class="text-center"><a style="cursor: pointer;" onclick="location.href='login'"><i class="fa fa-windows"></i> <span>Silahkan Login disini</span></a></h3>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->

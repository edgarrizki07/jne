<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
	<?php if($info['cek'] =='0'){ ?>
			<a target="_blank" href="<?php echo site_url('so/pdf_po/'.$info['id']);?>" class="btn btn-success" ><i class='fa fa-print'></i> Print</a>
			<a href="<?php echo site_url('so/list_po');?>" class="btn btn-warning" ><i class='fa fa-reply'></i>  Kembali</a>
		<?php if($info['status'] =='0'){ ?>
			<a title="Buat SO" href="<?php echo site_url('so/add/'.$info['id']);?>" class="btn btn-primary" ><i class='fa fa-plus'></i> Buat SO </a>
		<?php } ?>
	<?php }else{ ?>

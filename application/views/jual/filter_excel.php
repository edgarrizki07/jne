...
header("Content-Disposition: attachment; filename=Rekap_Penjualan_.xls");
...
$sekarang = date("d-m-Y");
?>
  <h3 class="box-title">Rekap Penjualan </h3> <?php if($uri3==''){ ?><?php }else{ ?><h4 class="pull-right">Date : <?php echo $this->jurnal_model->tgl_indo($uri4); ?> - <?php echo $this->jurnal_model->tgl_indo($uri5); ?></h4><?php } ?>
...
<?php if($isi->num_rows()>0){
	...
	<tbody>
		...
		<?php } ?>
			<td><?php echo $this->customer_model->NamaCustomer(($db['customer_id']));?></td>

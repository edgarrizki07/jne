<?php
// Buat File 
$NamaFile  = './files/invoice/Invoice No.'.$this->uri->segment(3).'.pdf';
...
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(0.5,0.5,"",0,0,'L'); 
$this->fpdf->Cell(11.3,0.5,substr($AlamatCustomer,0,70),0,0,'L');
$this->fpdf->Cell(7.5,0.5,$alamat,0,0,'L'); 

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(0.5,0.5,"",0,0,'L'); 
$this->fpdf->Cell(11.3,0.5,$Alamat1Customer,0,0,'L'); 
$this->fpdf->Cell(7.5,0.5,$alamat1,0,0,'L'); 

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(0.5,0.5,"",0,0,'L'); 
$this->fpdf->Cell(11.3,0.5,$KotaCustomer." - ".$ProvinsiCustomer,0,0,'L'); 
$this->fpdf->Cell(7.5,0.5,$kota." - ".$provinsi,0,0,'L'); 

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(0.5,0.5,"",0,0,'L'); 
$this->fpdf->Cell(11.3,0.5,"Phone : ".$TelpCustomer,0,0,'L'); 
$this->fpdf->Cell(7.5,0.5,"Phone : ".$telp,0,0,'L'); 

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(0.5,0.5,"",0,0,'L'); 
$this->fpdf->Cell(11.3,0.5,"Fax : ".$FaxCustomer,0,0,'L'); 
$this->fpdf->Cell(7.5,0.5,"Fax : ".$fax,0,0,'L'); 
...
$this->fpdf->Cell(1,0.5,"Rp",0,0,'R');
$this->fpdf->Cell(2,0.5,$ng_total,0,0,'R');
...
$this->fpdf->Ln(2);
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(9.5,0.5,$bank,0,0,'C');
$this->fpdf->Cell(9.5,0.5,substr($keterangan,0,47),0,0,'C');

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(9.5,0.5,$namarek,0,0,'C');
if(strlen($keterangan) > 47){
$this->fpdf->Cell(9.5,0.5,substr($keterangan,47,54),0,0,'C');
}

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(9.5,0.5,$rekening,0,0,'C');
if(strlen($keterangan) > 100){
$this->fpdf->Cell(9.5,0.5,substr($keterangan,100,70),0,0,'C');
}

$this->fpdf->Ln(4.5);
$this->fpdf->SetFont('Arial','B',8);
$this->fpdf->Cell(15.2,0.5,"",0,0,'L');
$this->fpdf->Cell(2.5,0.5,$penjualan,0,0,'C');

$this->fpdf->Ln();
$this->fpdf->SetFont('Arial','',8);
$this->fpdf->Cell(15.2,0.5,"",0,0,'L');
$this->fpdf->Cell(2.5,0.5,"Director",0,0,'C');

$this->fpdf->Output($NamaFile,"F");
redirect('jual/email_acc/'.$this->uri->segment(3));
?>

		...
		<div class="box box-warning">
			...
			<div class="box-body">
				...
				<div class="form-group has-success">
					<label><strong>Pilih Gambar Header</strong></label>
					<input name="gambar" type="file"/>
					<div class="box-body text-center">
						<?php if($info['header']==''){ ?>
						<img width="1000px" src="<?php echo base_url();?>uploads/setting/header.png"/>
						<?php }else{ ?>
						Nama File : <?php echo $info['header'];?><br/><br/>
						<img width="1000px" src="<?php echo base_url('/uploads/setting/'.$info['header']);?>"/>
						<?php } ?>
					</div><!-- /.box-body -->
				</div>
			</div><!-- /.box-body -->

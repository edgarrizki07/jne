...
?>
                <div class="box-header with-border">
                  <h3 class="box-title">Data PPH 21</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
	...
	<div class="box-footer">
		...
		<?php
			...
			if($act!='add')
			{
				echo form_button(array('id' => 'button-print', 'class' => 'btn btn-success', 'content' => 'Cetak', 'onClick' => "window.open('".site_url()."laporan_pph21/cetak/".$laporan_data['id']."')" ));
			}
			$cancel_text = ($act=='view') ? 'Kembali' : 'Batal';
			echo form_button(array('id' => 'button-cancel', 'class' => 'btn btn-warning', 'content' => $cancel_text, 'onClick' => "location.href='".site_url()."laporan_pph21'" ));
		?>
		</div>
	</div>

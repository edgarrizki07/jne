...
$this->fpdf->Cell(3.75,0.5,"Nomor",0,0,'L');
$this->fpdf->Cell(3,0.5,"Jurnal - Voucher",0,0,'L');
$this->fpdf->Cell(6.5,0.5,"Perkiraan",0,0,'L');
...
if($journal_data)
{
	...
	foreach ($journal_data as $row)
	{
		...
		$v = $this->jurnal_model->JenisVoucher($this->jurnal_model->VoucherId($row->id));
			...
			$this->fpdf->Cell(3.75,0.5,$nomor."/".$kode."/".$no."/".$cab."/".$bln."/".$thn,0,0,'L');
			$this->fpdf->Cell(3,0.5,$j." ".$p." - ".$v,0,0,'L');
			$this->fpdf->Cell(6.5,0.5,$row->kelompok_akun_id."-".$row->kode." ".$row->account_name,0,0,'L');
...
if($from==''){
	...
	$this->fpdf->Cell(4.5,0.5,"BULAN INI",0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebitBulanIni,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKreditBulanIni,0,0,'R');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"BULAN SEBELUMNYA",0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebitBulanLalu,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKreditBulanLalu,0,0,'R');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"TGL : ".$tgl1." sd ".$tgl2,0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebitTgl,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKreditTgl,0,0,'R');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"TGL : ALL sd ".$tgl0,0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebitTglP,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKreditTglP,0,0,'R');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"TGL : ".$tgl3." sd ".$sekarang,0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebitTglN,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKreditTglN,0,0,'R');
	}
...
$this->fpdf->Cell(8.5,0,"",'B',0,'C');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"SEMUA",0,0,'L');
	$this->fpdf->Cell(2,0.5,$KatDebit,0,0,'R');
	$this->fpdf->Cell(2,0.5,$KatKredit,0,0,'R');
	...
	$this->fpdf->Cell(3.75,0.5,"",0,0,'L');
	$this->fpdf->Cell(5,0.5,"",0,0,'L');
	$this->fpdf->Cell(4.5,0.5,"SALDO",0,0,'L');
	$this->fpdf->Cell(2,0.5,$db,0,0,'R');
	$this->fpdf->Cell(2,0.5,$kd,0,0,'R');

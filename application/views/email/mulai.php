<head>
	<title>Berhasil Kirim Email</title>
</head>
<script type="text/javascript"> cleartext();  </script>
<script>
	var time = null
	function move() {
	window.location = '<?php echo site_url('email/mulai');?>'; }
</script>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
								...
								<div class="text-center">
									...
									<a href="<?php echo site_url('email/mulai');?>" class="btn btn-danger"><i class="fa fa-play"></i><b> Lanjutkan</b></a>
...
<audio controls autoplay>
	<source src="<?php echo base_url('sound/'.$this->app_model->Terkirim());?>" type="audio/mpeg" />
</audio>

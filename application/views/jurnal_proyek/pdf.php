...
$this->fpdf->Cell(2,0.5,"Voucher No ",'0',0,'L');
$this->fpdf->Cell(5,0.5,": ".$nomor."/".$kode."/".$no."/".$cab."/".$bln."/".$thn,0,0,'L');

$this->fpdf->Ln();
$this->fpdf->SetFont('Times','',11);
if($info['customer_id']==''){ }else{ $this->fpdf->Cell(3,0.5,"NPWP",0,0,'L');} 
$this->fpdf->Cell(7,0.5,": $journal2",0,0,'L');
$this->fpdf->Cell(2,0.5,"Date ",0,0,'L');
$this->fpdf->Cell(5,0.5,": $tgl",0,0,'L');
...
$this->fpdf->Cell(2,0.5,"Due Date ",0,0,'L');
$this->fpdf->Cell(5,0.5,": $tempo",0,0,'L');
}
...
$this->fpdf->Cell(7,0.5,"Pencatat",0,0,'L');
$this->fpdf->Cell(7,0.5,"Penerima ",0,0,'L');
$this->fpdf->Cell(2,0.5,"Transaksi BBM",0,0,'L');

$this->fpdf->Ln();
$this->fpdf->SetFont('Times','',11);
$this->fpdf->Cell(7,0.5,"$user1"." - ".$addr1,0,0,'L');
$this->fpdf->Cell(7,0.5,"$user2"." - ".$addr2,0,0,'L');
$this->fpdf->Cell(2,0.5,"$jenis",0,0,'L');

$this->fpdf->Ln();
$this->fpdf->SetFont('Times','',11);
$this->fpdf->Cell(1,0.5,"Phone",0,0,'L');
$this->fpdf->Cell(6,0.5," : $phone1",0,0,'L');
$this->fpdf->Cell(1,0.5,"Phone",0,0,'L');
$this->fpdf->Cell(6,0.5," : $phone2",0,0,'L');

$this->fpdf->Ln();
$this->fpdf->SetFont('Times','',11);
$this->fpdf->Cell(1,0.5,"Email",0,0,'L');
$this->fpdf->Cell(6,0.5," : $email1",0,0,'L');
$this->fpdf->Cell(1,0.5,"Email",0,0,'L');
$this->fpdf->Cell(6,0.5," : $email2",0,0,'L');
...
$no=0; foreach($detail_jurnal as $row ): $no++; $kode = $this->akun_model->KodeAkun($row->akun_id); $kode = $this->akun_model->KodeAkun($row->akun_id); $nama = $this->akun_model->NamaAkun($row->akun_id);
...
$this->fpdf->Output("Jurnal_BBM_$nomor.pdf","I");
?>
